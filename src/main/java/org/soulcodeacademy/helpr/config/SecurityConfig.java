...
public class SecurityConfig {
   ...
   // AuthenticationManager é classe por trás de toda o gerenciamentoda autenticação do usuário
    @Bean
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests()
                .antMatchers(PUBLIC_ENDPOINTS).permitAll() // Possibilita os endpoints no array serem Publicas
